...
var products = [
  {
    ...
    light: '#DCFCE7',
    soft: '#86EFAC',
    img: 'wahaha/products/220新AD.png',
  ...
  },
  {
    ...
    light: '#FFE4E6',
    soft: '#FDA4AF',
    img: 'wahaha/products/220AD草莓味新瓶型.png',
  ...
  },
  {
    ...
    light: '#FEF3C7',
    soft: '#FCD34D',
    img: 'wahaha/products/220AD蜜桃味新瓶型.png',
  ...
  },
  {
    ...
    light: '#F3E8FF',
    soft: '#D8B4FE',
    img: 'wahaha/products/450新AD胶原蛋白.png',
  ...
  },
  {
    ...
    light: '#E0F2FE',
    soft: '#7DD3FC',
    img: 'wahaha/products/450新AD乳酸菌.png',
...
const resultData = {
  original: {
    ...
    product: 'wahaha/products/220新AD.png',
  ...
  strawberry: {
    ...
    product: 'wahaha/products/220AD草莓味新瓶型.png',
  ...
  peach: {
    ...
    product: 'wahaha/products/220AD蜜桃味新瓶型.png',
  ...
  collagen: {
    ...
    product: 'wahaha/products/450新AD胶原蛋白.png',
  ...
  lacto: {
    ...
    product: 'wahaha/products/450新AD乳酸菌.png',
